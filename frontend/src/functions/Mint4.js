...
const Mint4 = () => {
  ...
  return (
    ...
    blockchain.smartContract === null ? (
        <button style={{padding: 5, paddingLeft: 20, paddingRight: 20}} onClick={() => {dispatch(connect4())}}>Connect your Wallet to Purchase the Branch</button>
        ) : (
          <>
