...
const MintNFTButton2 = () => {
  ...
  const contractAddress = '0xf5c2C88D0275612D6e02f2C594C17a0B7527C501';
  ...
  return (
    <div>
      <button className="lognBtn" style={{paddingLeft: 20, paddingRight: 20}}onClick={handleMintNFT}>Confirm</button>
      <br></br>
      <br></br>
      <img src={img} width="125px" />
      <br></br>
        <br></br>
        <b>Transaction Status:</b><br></br><b style={{color: "red"}}>{feedback}</b>
    </div>
  );
};
export default MintNFTButton2;